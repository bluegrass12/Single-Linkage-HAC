...
Output: 
- Z.npy, a numpy array representing the hierarchical clustering encoded as a linkage matrix
- a dendrogram visualizing the hierarchical clustering

Usage (in Command Line/Terminal): python3 SingleLinkageHAC <csvfile> <# of CSV rows to include> <feature1> <...> <feature x> 

Notes: 
- Features must be numeric. Nonnumeric features will be removed and won't impact clustering
